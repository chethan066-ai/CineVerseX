...
class Movie(db.Model):
    ...
    justwatch_url = db.Column(db.String(500))
    bookmyshow_url = db.Column(db.String(500))
    bookmyshow_movie_url = db.Column(db.String(500))
    bookmyshow_ticket_url = db.Column(db.String(500))
    interested_count = db.Column(db.Integer, default=0)
    release_status = db.Column(db.String(50), default="Coming Soon")
